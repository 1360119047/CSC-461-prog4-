        ...
        if (inputTriangles == String.null)
            ...
            for (var whichSet=0; whichSet<numTriangleSets; whichSet++) { // for each tri set
                ...
                for (whichSetVert=0; whichSetVert<numVerts; whichSetVert++) { // verts in set
                    ...
                    //add for texture
                    uvToToAdd = inputTriangles[whichSet].uv[whichSetVert]; // get uv to add
...
function loadTexture(url) {
    ...
    full_url = "https://ncsucgclass.github.io/prog3/" + url
    image.src = full_url ;
...
function setupShaders() {
    ...
    var vShaderCode = `
        ...
        attribute vec2 aVertexTexture; // vertex normal
        ...
        void main(void) {
            ...
            gl_Position = upvmMatrix * upvmMatrix * vec4(aVertexPosition, 1.0);
